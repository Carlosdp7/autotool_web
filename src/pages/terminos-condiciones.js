  ...
  return (
    <Layout headerNavBg={true}>
      ...
      <section css={css`background-color:#fff;`}>
        <Container className="py-5" css={css`color: #000; h3,h2,h1{margin-bottom:1rem !important;} p{margin-bottom: 1rem;}li{&:last-of-type {margin-bottom:1rem;}}`}>
          <Row>
            <Col xs={12}>
              ...
              <h2>Sección 3 – Exactitud, exhaustividad y actualidad de la información</h2>
              ...
              <h2>Sección 8 – Enlaces de terceras partes</h2>
              ...
              <h2>Sección 9 – Comentarios de usuarios, captación y otros envíos</h2>
              ...
              <h2>Sección 13 – Exclusión de garantías; limitación de responsabilidad</h2>
              ...
              <h2>Sección 18 – Política de devoluciones</h2>
              ...
              <ul>
                <li>Puede contactarnos por medio de nuestro de número telefónico: +57 324 289 2433, correo electrónico: autotool.co@gmail.com o por medio de nuestro instagram @autotool.co</li>
              </ul>
              ...
              <ul>
                <li>Estar en las mismas condiciones en que lo recibiste. También debe estar en su embalaje original.</li>
                <li>Comprobar que el producto está defectuoso o no tuvo la vida util que se esperaba, hay algunas situaciones donde solo se pueden garantizar reembolsos parciales:</li>
                <ul className="ms-5">
                  <li>Cualquier producto que no se encuentre en su condición original, que esté dañado o le falten partes por razones ajenas a nosotros.</li>
                </ul>
              </ul>
              ...
              <h2>Sección 20 – Cambios en los términos de servicio</h2>
              ...
              <h2>Sección 21 – Información de contacto</h2>
              <p>Preguntas acerca de los Términos de Servicio deben ser enviadas a autotool.co@gmail.com.</p>

              <p className="text-muted small">Preguntas acerca de los Términos de Servicio deben ser enviadas a autotool.co@gmail.com.</p>
            </Col>
          </Row>
        </Container>
      </section>
